@extends('layouts.main')
   ...
   <!-- Meta Item -->
    ...
    <title>{{ $meta['meta'][$lang]['title'] ?? 'tiktok.digimar.id - Maksimalkan Bisnismu Lewat TikTok Marketing' }}</title>
    <meta name="description" content="{{ $meta['meta'][$lang]['description'] ?? 'Gunakan kekuatan video pendek untuk menjangkau audiens lebih luas. Tingkatkan brand awareness dan penjualan dengan strategi TikTok bersama Digimar.' }}">
    <meta name="keywords" content="{{ $meta['meta'][$lang]['keywords'] ?? 'tiktok marketing, strategi tiktok, konten viral, video pendek, promosi bisnis di tiktok, tiktok ads, branding tiktok, influencer tiktok, tiktok bisnis, manajemen tiktok, digimar tiktok' }}">
   <!-- Schema Item -->
    {{-- Schema Item --}}
